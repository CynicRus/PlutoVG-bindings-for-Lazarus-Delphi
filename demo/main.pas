...
uses
  Classes, SysUtils, Forms, Controls, Graphics, Dialogs, ExtCtrls, StdCtrls, plutovg_api;
...
begin
  ...
  Data := plutovg_surface_get_data(Surface);
...
begin
  ...
  try
    FFont := plutovg_font_face_load_from_file('Bubble Sans.ttf', 0);
    if FFont = nil then
